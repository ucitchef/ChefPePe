...
import './DesertsRecipe.css';
import browniesData from '../json/brownies.json';
import applePieData from '../json/applePie.json';

const recipes = [applePieData, browniesData];
