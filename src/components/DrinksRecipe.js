...
import './DrinksRecipe.css';
import classicMojitoData from '../json/classicMojito.json';
import freshLemonadeData from '../json/freshLemonade.json';

const recipes = [classicMojitoData, freshLemonadeData];
