...
import './ChickenRecipe.css';
import chickenData from '../json/chicken.json';
import chickenPotPieData from '../json/chickenPotPie.json';

const recipes = [chickenData, chickenPotPieData];
